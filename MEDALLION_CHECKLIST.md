...
| # | Origem `dbo.*` | Linhas | Silver `2_silver.*` | Gold `3_gold.*` | Status Silver |
|---|---|---|---|---|---|
| 1 | customer            | 701 | customer            | dim_customer          | ✅ feito (701) |
| 2 | account             | 35  | account             | dim_account           | ✅ feito |
| 3 | account_header      | 10  | account_header      | dim_account_header    | ⬜ próximo |
| 4 | organization        | 9   | organization        | dim_organization      | ⬜ |
| 5 | department_group    | 7   | department_group    | dim_department_group  | ⬜ |
| 6 | geography           | 638 | geography           | dim_geography ┐       | ⬜ |
| 7 | region              | 11  | region              | dim_geography ┘ (join)| ⬜ |
| 8 | product             | 349 | product             | dim_product ┐         | ⬜ |
| 9 | product_sub_category| 18  | product_sub_category| dim_product ┘ (join)  | ⬜ |

## Fatos (5) — depois das dims

| # | Origem `dbo.*` | Linhas | Silver `2_silver.*` | Gold `3_gold.*` | Status Silver |
|---|---|---|---|---|---|
| 10 | sales_header         | 3.796  | sales_header         | (join no fct_sales_details) | ⬜ |
| 11 | sales_details        | 60.855 | sales_details        | fct_sales_details           | ⬜ |
| 12 | sales_returns        | 3.869  | sales_returns        | fct_sales_returns           | ⬜ |
| 13 | finance              | 49.944 | finance              | fct_finance                 | ⬜ |
| 14 | product_cost_history | 12.231 | product_cost_history | fct_product_cost_history    | ⬜ |
